...
import { Card, Tooltip, Button, Select, Row, Col } from 'antd'
import {
    ClockCircleTwoTone,
    VideoCameraOutlined,
        ...
        return (
            ...
            >
                <Row style={{ width: "100%", justifyContent: "center" }}>
                    <video ref={(videoRef == null) ? imageSrc : videoRef} autoPlay width="300" height="200" style={{ border: "1px solid ", borderRadius: "5px", margin: "10px" }}></video>
                </Row>
                <Row style={{ width: "100%" }}>
                    <Col>
                        <Select
