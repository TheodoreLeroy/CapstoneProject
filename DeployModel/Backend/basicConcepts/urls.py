...
urlpatterns = [
    ...
    # Slot
    path('class<int:classId>/createSlot',
         views.SlotInfomation.as_view(), name="create-slot"),
    path("slot/", views.SlotInfomation.as_view(), name="slot-information"),
    path("class<int:classId>/slot/", views.SlotInfomationFromIdClass.as_view(),
         name="slot-information-from-one-class"),
    path("slot<int:slotId>/", views.SlotInfomationFromId.as_view(),
    ...
    path("timeFrame<int:timeFrameId>/",
         views.GetAttendentStudentsAtOneFrame.as_view(), name="a-time-frames-of-slot"),
    # attentdent
