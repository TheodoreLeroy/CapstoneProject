# Generated by Django 5.1 on 2024-08-19 19:47

import basicConcepts.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basicConcepts.logs')),
            ],
        ),
        migrations.CreateModel(
            name='Slot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=basicConcepts.models.Student.student_image_path)),
                ('class_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basicConcepts.class')),
            ],
        ),
        migrations.AddField(
            model_name='logs',
            name='student_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basicConcepts.student'),
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('embedding', models.ImageField(upload_to=basicConcepts.models.TimeFrame.student_image_path)),
                ('slot_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basicConcepts.slot')),
            ],
        ),
        migrations.CreateModel(
